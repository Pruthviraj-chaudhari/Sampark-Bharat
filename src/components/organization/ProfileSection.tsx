      ...
      <div className="container grid grid-cols-1 lg:grid-cols-2 gap-8 px-4 md:px-6">
        ...
        <div className="flex flex-col items-start gap-6 px-4 md:px-0">
          {loading ? (
            ...
            <h2 className="text-slate-200 text-3xl font-bold sm:text-4xl md:text-5xl">
              {profile?.name}
            </h2>
          )}
          {loading ? (
            ...
            <span className="text-2xl text-slate-300 font-bold tracking-wider">
              {profile?.position}
            </span>
          )}
          {loading ? (
          ...
          <div className="flex flex-col md:flex-row items-start md:items-center gap-4">
            <div className="flex items-center gap-2">
              ...
              {loading ? (
                ...
                <span className="cursor-pointer text-slate-300 hover:text-muted transition-colors">
                  {profile?.location}
                </span>
              )}
            </div>
