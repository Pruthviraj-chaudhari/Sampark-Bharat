                ...
                <div className="flex gap-2">
                    <Dialog>
                        <DialogTrigger asChild>
                            <Button className="border-2 border-slate-900 hover:bg-slate-900 hover:text-white" variant={"outline"}><span className="hidden md:inline">Share</span> <GoShareAndroid className=" ml-1 w-4 h-4" /></Button>
                        </DialogTrigger>
