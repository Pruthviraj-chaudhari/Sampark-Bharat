            ...
            <div className="container flex h-16 items-center justify-between px-4 md:px-6">
                ...
                <div className="flex gap-2">
                    ...
                    <a href="https://samparkbharat.com/auth/register" target="_blank">
                        <Button className={`border-2 border-${themeClasses.textPrimary} hover:bg-${themeClasses.background} hover:text-white`} variant={"outline"}> <span className="hidden md:inline">Get Your vCard</span> <RiContactsLine className=" ml-1 w-4 h-4" /></Button>
                    </a>
                </div>
            </div>
        </header>
