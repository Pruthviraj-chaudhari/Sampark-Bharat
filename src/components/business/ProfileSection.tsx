      ...
      <div className="container grid grid-cols-1 lg:grid-cols-2 gap-8 px-4 md:px-6">
        ...
        <div className="flex flex-col items-start gap-6 px-4 md:px-0">
          {loading ? (
            ...
            <Balancer className="text-3xl text-black font-bold tracking-tighter sm:text-4xl md:text-5xl">
              {profile?.name}
            </Balancer>
          )}
          {loading ? (
            ...
            <Balancer className="text-lg text-blue-600 font-bold tracking-wider">
              {profile?.position}
            </Balancer>
          )}
          {loading ? (
            ...
            <Balancer className="text-muted-foreground md:text-xl leading-relaxed">
              {profile?.description}
            </Balancer>
          )}
          <div className="flex flex-col md:flex-row items-start md:items-center gap-4">
            <div className="flex items-center gap-2">
              ...
              {loading ? (
                ...
                <Balancer className="cursor-pointer hover:text-primary transition-colors">
                  {profile?.location}
                </Balancer>
              )}
            </div>
